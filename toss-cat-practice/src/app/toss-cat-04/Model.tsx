...
export function Model(props: any) {
  ...
  const animationing = useRef(false);
  ...
  const onClickCat = async (event: any) => {
    if (animationing.current) return;
    animationing.current = true;
    props?.addBalloon(event);
    setActive(true);
    await delay(700);
    animationing.current = false;
  }
